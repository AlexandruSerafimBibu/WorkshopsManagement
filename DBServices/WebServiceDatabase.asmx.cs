...
namespace DatabaseService
{
    ...
    public class WebServiceDatabase : System.Web.Services.WebService
    {
        ...
        public List<string> getWorkshops()
        {
            ...
            {
                temp.Add(dr.ItemArray.GetValue(5).ToString() + "@" +
        ...
        public void addAnswer(string answer, string user, int qid)
        {
            myCon.Open();
            dsAnswers = new DataSet();
            daAnswers = new SqlDataAdapter("INSERT INTO Answers (Answer,UserName,QuestionId)" +
                " VALUES(@answer,@user,@qid)", myCon);
